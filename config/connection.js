...
// JAWSDB_URL environment variable if available, otherwise use the DB_NAME, 
// DB_USER, and DB_PASSWORD environment variables to connect to a local MySQL database
